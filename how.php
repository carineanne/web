...
<form method="POST">
	<div style="height:260px; width: 200px;background-color:aliceblue;">

			<center><b><label>DASH BORD</label></center></b>
	<a href="home.php" style="text-decoration: none;color: black;"><ol><li><label>HOME</label></li></ol></a>
...
<div style="font-size: 20px;">
	<center>
	<p>when you are going to pour water<br>
      you will enter money then click on ENTER<br>
      button then pour the water corresponding<br>
       to the amount he put in it.
 </p>
</center>
</div>
</center>
